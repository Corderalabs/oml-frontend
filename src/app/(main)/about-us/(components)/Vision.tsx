  ...
  return (
    <section className='w-full px-4 py-10 text-center bg-white'>
      ...
      <p className='text-gray-700 max-w-3xl mx-auto mt-6 text-sm md:text-base'>
        <strong>ONE MILLION LANDLORD</strong> is a consulting firm in real
        estate offering quality, transparent choices, both in the types of
        services that you can receive and how those services can be paid for,
        with a mission to bring service, value and care to our residents.
      </p>
